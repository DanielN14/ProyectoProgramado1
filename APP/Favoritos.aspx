<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Favoritos.aspx.cs" Inherits="Proyecto_Programado_1.APP.Favoritos" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h3 style="text-align: center; margin-top:10px">Mis favoritos <i class="fa fa-star"></i></h3>
        <div class="container-fluid">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body btnCards">
                                        ...
                                        <a class="btn btn-outline-danger" onclick="cargarIdFav('<%# Eval("IdFav") %>')" data-toggle="modal" data-target="#CancelDialog" style="position: absolute; bottom: 10px; font-size: 11px; border-radius: 8px; width: 33%; max-height: 35px;">Quitar</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Quitar Favoritos:
                    ...
                    <div class="modal-body">
                        ¿Esta seguro que desea quitar el libro del favoritos?
                    </div>
